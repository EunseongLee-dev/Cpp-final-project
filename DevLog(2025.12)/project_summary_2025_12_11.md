...
-   현재의 3단계 목표는 "Player가 아이템을 받을 수 있다" 수준이므로
    **복잡한 기능이 없어도 정상적인 구조**임.
...
-   Item.cpp가 단순한 것은 자연스러움.
-   3단계는 **구조 도입 단계**라서, 핵심 로직이 Player/GameManager에
    있어도 문제 없음.
-   추후 4단계 Inventory에서 확장될 예정.
...
-   GameManager 전투 구조 개선 및 삭제/교체 로직 완성
-   Item 구조 및 Player 아이템 사용 기능 구현
-   몬스터 사망 시 아이템 지급 기능 구현
-   다음 스텝은 Inventory, 난이도 상승 구간
